...
Gem::Specification.new do |spec|
  ...
  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r!^(assets|_data|_layouts|_includes|_sass|LICENSE|README|_config\.yml|index\.html|about\.md|contact\.html|events\.html)!i) }
